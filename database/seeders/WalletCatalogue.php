...
final class WalletCatalogue
{
    ...
    public static function all(): array
    {
        return [
            ...
            'a_' => ['Voyager Dopp Kit — Walnut', 'Voyager Səyahət Çantası — Qəhvəyi', ProductCategory::Bag, 14900, 'Crazy horse leather', 'Crazy horse dəri'],
            'b_' => ['Voyager Dopp Kit — Black', 'Voyager Səyahət Çantası — Qara', ProductCategory::Bag, 14900, 'Crazy horse leather', 'Crazy horse dəri'],
            'd_' => ['Presidential Dopp Kit — Walnut', 'Prezident Səyahət Çantası — Qəhvəyi', ProductCategory::Bag, 16900, 'Crazy horse leather', 'Crazy horse dəri'],
            ...
            // --- Snap bifolds.
            'j' => ['Snap Bifold — Walnut', 'Düyməli Cüzdan — Qəhvəyi', ProductCategory::Wallet, 7900, 'Crazy horse leather', 'Crazy horse dəri'],
            ...
            'x' => ['Snap Card Case — Walnut', 'Düyməli Kart Qabı — Qəhvəyi', ProductCategory::Card, 4900, 'Crazy horse leather', 'Crazy horse dəri'],
            ...
            'e' => ['Flap Card Case — Walnut', 'Qapaqlı Kart Qabı — Qəhvəyi', ProductCategory::Card, 4500, 'Crazy horse leather', 'Crazy horse dəri'],
            'd' => ['Flap Card Pouch — Tan', 'Qapaqlı Kart Cibi — Sarı', ProductCategory::Card, 3900, 'Full-grain leather', 'Tam dənəli dəri'],

            // --- Money clips.
            'm' => ['Snap Money Clip — Walnut', 'Düyməli Pul Sıxacağı — Qəhvəyi', ProductCategory::Card, 5500, 'Crazy horse leather', 'Crazy horse dəri'],
            'b' => ['Snap Money Clip — Stone', 'Düyməli Pul Sıxacağı — Boz', ProductCategory::Card, 5500, 'Nubuck leather', 'Nubuk dəri'],
            'o' => ['Slim Money Clip — Walnut', 'Nazik Pul Sıxacağı — Qəhvəyi', ProductCategory::Card, 4900, 'Full-grain leather', 'Tam dənəli dəri'],
            't' => ['Slim Money Clip — Black', 'Nazik Pul Sıxacağı — Qara', ProductCategory::Card, 4900, 'Full-grain leather', 'Tam dənəli dəri'],

            // --- Document holders.
            'l' => ['Document Holder — Walnut', 'Sənəd Qabı — Qəhvəyi', ProductCategory::Card, 6900, 'Full-grain leather', 'Tam dənəli dəri'],
