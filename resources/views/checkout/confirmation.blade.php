...
<x-layouts.storefront :title="__('shop.confirmation.title')" :live-cart="false">
    <div class="mx-auto max-w-2xl px-6 py-24 text-center">
        <h1 class="font-display text-3xl tracking-wide">{{ __('shop.confirmation.title') }}</h1>
        ...
        <a href="{{ route('storefront.catalogue', absolute: false) }}"
           class="mt-12 inline-block bg-ink px-6 py-4 text-center font-display text-sm tracking-widest text-ground hover:bg-accent">
