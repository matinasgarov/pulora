...
<a href="{{ route('storefront.product', ['slug' => $product->slug], absolute: false) }}" class="group block">
    ...
    <div class="flex aspect-[3/4] items-center justify-center bg-ground-alt p-12">
        @if ($image)
    ...
    <div class="py-4 text-center">
        <h2 class="font-display text-base">{{ $product->name }}</h2>
        <p class="mt-1 font-display text-sm text-accent"><x-price :minor="$product->base_price_minor" /></p>
    </div>
</a>
